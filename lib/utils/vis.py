    ...
    for i in range(batch_size):
        ...
        for j in range(len(proposal_centers[i])):
            if proposal_centers[i, j, 3] < 0:
                continue
            # change
            top_left_x = float(proposal_centers[i, j, 0] - proposal_centers[i, j, 5] * individual_space_size[0] / 2)
            top_left_y = float(proposal_centers[i, j, 1] - proposal_centers[i, j, 6] * individual_space_size[1] / 2)
            width = float(proposal_centers[i, j, 5] * individual_space_size[0])
            height = float(proposal_centers[i, j, 6] * individual_space_size[1])
        ...
        for j in range(len(proposal_centers[i])):
            ...
            # change
            top_left_x = float(proposal_centers[i, j, 0] - proposal_centers[i, j, 5] * individual_space_size[0] / 2)
            top_left_y = float(proposal_centers[i, j, 2] - individual_space_size[2] / 2)
            width = float(proposal_centers[i, j, 5] * individual_space_size[0])
            height = float(individual_space_size[2])
            rect = plt.Rectangle((top_left_x, top_left_y), width, height, fill=False, edgecolor = 'red',linewidth=1)
            ax.add_patch(rect)
        ...
        for j in range(len(proposal_centers[i])):
            if proposal_centers[i, j, 3] < 0:
                continue
            # change
            top_left_x = float(proposal_centers[i, j, 1] - proposal_centers[i, j, 6] * individual_space_size[1] / 2)
            top_left_y = float(proposal_centers[i, j, 2] - individual_space_size[2] / 2)
            width = float(proposal_centers[i, j, 6] * individual_space_size[1])
            height = float(individual_space_size[2])
            rect = plt.Rectangle((top_left_x, top_left_y), width, height, fill=False, edgecolor = 'red',linewidth=1)
            ax.add_patch(rect)
